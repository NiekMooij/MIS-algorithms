...
ax2.errorbar(df['k'], df['LV_app'], yerr=(df['LV_app'] - df['LV_app_CI_lower'], df['LV_app_CI_upper'] - df['LV_app']), marker='s', color=cud_palette[0], capsize=3)
ax2.scatter([], [], label='LV', marker='s', color=cud_palette[0])

ax2.errorbar(df['k'], df['continuation_app'], yerr=(df['continuation_app'] - df['continuation_app_CI_lower'], df['continuation_app_CI_upper'] - df['continuation_app']), marker='o', color=cud_palette[1], capsize=3)
ax2.scatter([], [], label='CLV', marker='o', color=cud_palette[1])

ax2.errorbar(df['k'], df['greedy_app'], yerr=(df['greedy_app'] - df['greedy_app_CI_lower'], df['greedy_app_CI_upper'] - df['greedy_app']), marker='^', color=cud_palette[2], capsize=3)
ax2.scatter([], [], label='Greedy', marker='^', color=cud_palette[2])

ax2.legend()
ax2.set_xlabel('r')
ax2.set_ylabel('Approximation factor')
# ax2.set_xticks([0, 0.25, 0.50, 0.75, 1.00, 1.25, 1.50], ['0.00', '0.25', '0.50', '0.75', '1.0', '1.25', '1.50'])

ax2.set_xticks([0.0, 0.3, 0.6, 0.9, 1.2, 1.5], ['0.0', '0.3', '0.6', '0.9', '1.2', '1.5'])

ax2.set_yticks([0.85, 0.90, 0.95, 1.0], ['0.85', '0.90', '0.95', '1.00'])
...
ax1.set_xticks([12, 14, 16, 18, 20, 22, 24], [12, 14, 16, 18, 20, 22, 24])
...
ax_inset.set_xticks([12, 14, 16, 18, 20, 22, 24], [12, 14, 16, 18, 20, 22, 24])
