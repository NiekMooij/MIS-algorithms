...
df = pd.read_pickle(os.path.join(sys.path[0], f"data/Size_Performance_plognn/data.pkl"))
...
ax3.set_yticks([0.92, 0.94, 0.96, 0.98, 1.0], ['0.92', '0.94', '0.96', '0.98', '1.00'])
...
ax5.set_yticks([0.75, 0.80, 0.85, 0.90, 0.95, 1.0], ['0.75', '0.80', '0.85', '0.90', '0.95', '1.00'])

# -------------------------------------------------------------------------------------------------------------------------------------------------

# Output_Counts_Histogram_size60_p01
...
df = pd.read_pickle(os.path.join(sys.path[0], f"data/Size_Efficiency_plognn/data.pkl"))
...
ax6.set_yticks([0.00, 0.25, 0.50, 0.75, 1.0], ['0.00', '0.25', '0.50', '0.75', '1.00'])
